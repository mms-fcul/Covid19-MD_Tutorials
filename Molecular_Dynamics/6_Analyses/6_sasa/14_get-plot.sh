...
set ylabel "Interface SASA (nm^{2})"
set yrange [4.3:7]
...
plot \
     "sasa_interface_MPro-13b_A_average.xvg" u 1:2 w l lt 1 lw 8 lc rgb "#0000FF" title "LigA", \
     "sasa_interface_MPro-13b_B_average.xvg" u 1:2 w l lt 1 lw 8 lc rgb "#FF0000" title "LigB", \
