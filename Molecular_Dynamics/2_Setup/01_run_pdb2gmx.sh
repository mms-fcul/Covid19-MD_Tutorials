...
$grom pdb2gmx -f ../01_Preparation/${Sys}.pdb \
...
egrep "1O6K" ../01_Preparation/ligand1.gro >> aux_prot
egrep "2O6K" ../01_Preparation/ligand2.gro >> aux_prot
